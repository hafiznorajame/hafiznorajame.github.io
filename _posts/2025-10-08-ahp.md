...
Based on the output above, *P4* (Joint model) has the highest weighted value $w_{p4}=0.256$, followed by *P1*  and *P2*. *P5* has the lowest weighted value. So the ranking is as follow: *P4*>*P1*>*P2*>*P6*>*P3*>*P5*.
