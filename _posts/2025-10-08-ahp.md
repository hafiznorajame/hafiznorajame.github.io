...
For Theoretical, I think **P2** will involve lots of probability and statistical theory, whereas **P6** will mostly focus on data analysis and using existing common statistical model. Table 2 is my pairwise comparison matrix for this criterion.
...
Personally, I think I know more about **P6** since my final year project in my BSc is about analysing cancer data trend. Additionally, I did perform a statistical analysis using the linear mixed model on a cancer data. So that is my reason why I assign a higher scale on **P6**. 

**P5** is about epidemic model, which I believe involves stochastic model. I know a bit about stochastic but was not entirely confident whether I fully understand the theory. Hence, why I put a lower scale for this project. Table 3 is my full pairwise comparison matrix for Knowledge.
...
One of my interest in statistics is to build and understand robust statistical models that can handle irregularities such as non-linearity and non-normality. Additionally, I am also interested in medical statistics. So that's the reason why I put a higher weight for **P4**.
...
From the dissertation description, I think **P2** will involves lots of coding for simulation. Hence why I put a higher scale for this project. For *P6*, since it is about analysing cancer data and proposing a research goal for that dataset, I think this will be the least challenging in terms of coding.
